...
export const siteConfig: SiteConfig = {
	title: "Yolim Blog",
	subtitle: "把近况、知识、来路与喜欢的声音，安静地收进同一个地方。",
	...
	featurePages: {
		anime: false, // 暂不展示追番页面
		diary: true, // 日记页面开关
		friends: false, // 暂不展示友链页面
		projects: true, // 项目页面开关
		skills: true, // 技能页面开关
		timeline: true, // 时间线页面开关
		albums: false, // 暂不展示相册页面
	},
	...
	banner: {
		...
		waves: {
			...
			performanceMode: true, // 减少动画复杂度
			mobileDisable: true, // 移动端禁用水波纹
		},
	...
	links: [
		{
			...
			url: "https://github.com/yulinlu0228",
		},
	],
};
...
export const announcementConfig: AnnouncementConfig = {
	title: "写在前面", // 公告标题
	content: "这里记录生活、研究、知识与反复播放的旋律。内容会慢慢生长。", // 公告内容
...
export const musicPlayerConfig: MusicPlayerConfig = {
	enable: false, // 收到合法音频文件后再启用本地播放器
};
